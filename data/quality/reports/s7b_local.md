# Gate report - s7b_local

- finished: 2026-09-18 00:35:03
- result: **PASS** (346 passed / 0 failed)

- [x] word sources reachable over HTTP — episode:ep01=163, episode:ep02=215, episode:ep03=44, episode:yale_ep01=32, collection:harvard_justice=414, collection:yale_philosophy=32, collection:custom_imports=12, vocab-bank=502
...
- [x] episode:ep01/docx: body is not empty — 40209 bytes
- [x] episode:ep01/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] episode:ep01/docx: Content-Length matches the body — 40209 vs 40209
...
- [x] episode:ep01/study_guide_md: body is not empty — 48993 bytes
- [x] episode:ep01/study_guide_md: body is valid UTF-8 text — 42995 chars
...
- [x] episode:ep01/study_guide_md: English definitions (163) present in study_guide_md — 0 missing e.g. []
...
- [x] episode:ep01/anki_csv: body is not empty — 269255 bytes
- [x] episode:ep01/anki_csv: body is valid UTF-8 text — 255676 chars
...
- [x] episode:ep01/anki_csv: English definitions (163) present in anki_csv — 0 missing e.g. []
...
- [x] episode:ep01/eudic_quizlet: body is not empty — 45078 bytes
- [x] episode:ep01/eudic_quizlet: body is valid UTF-8 text — 39186 chars
- [x] episode:ep01/eudic_quizlet: body is not an error message — hurdling	/ˈhɜːrdlɪŋ/ v. (present participle) 疾驰、飞驰（形容失控电车高速冲下轨道）\nmoving rapidly and uncontrollably forward, as a vehicl
- [x] episode:ep01/eudic_quizlet: every word present in the eudic_quizlet payload — 0 missing e.g. []
- [x] episode:ep01/eudic_quizlet: English definitions (163) present in eudic_quizlet — 0 missing e.g. []
...
- [x] episode:ep01/words_only: body is not empty — 1743 bytes
- [x] episode:ep01/words_only: body is valid UTF-8 text — 1743 chars
- [x] episode:ep01/words_only: body is not an error message — hurdling
desperate
helpless
side track
sparing
...
- [x] episode:ep02/docx: body is not empty — 45135 bytes
- [x] episode:ep02/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] episode:ep02/docx: Content-Length matches the body — 45135 vs 45135
...
- [x] episode:ep02/study_guide_md: body is not empty — 63386 bytes
- [x] episode:ep02/study_guide_md: body is valid UTF-8 text — 58542 chars
...
- [x] episode:ep02/anki_csv: body is not empty — 358121 bytes
- [x] episode:ep02/anki_csv: body is valid UTF-8 text — 346280 chars
...
- [x] episode:ep02/eudic_quizlet: body is not empty — 58275 bytes
- [x] episode:ep02/eudic_quizlet: body is valid UTF-8 text — 53537 chars
...
- [x] episode:yale_ep01/docx: body is not empty — 17179 bytes
- [x] episode:yale_ep01/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] episode:yale_ep01/docx: Content-Length matches the body — 17179 vs 17179
...
- [x] collection:harvard_justice/docx: body is not empty — 84295 bytes
- [x] collection:harvard_justice/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] collection:harvard_justice/docx: Content-Length matches the body — 84295 vs 84295
...
- [x] collection:harvard_justice/study_guide_md: body is not empty — 121968 bytes
- [x] collection:harvard_justice/study_guide_md: body is valid UTF-8 text — 110675 chars
...
- [x] collection:harvard_justice/study_guide_md: English definitions (414) present in study_guide_md — 0 missing e.g. []
...
- [x] collection:harvard_justice/anki_csv: body is not empty — 685061 bytes
- [x] collection:harvard_justice/anki_csv: body is valid UTF-8 text — 658203 chars
...
- [x] collection:harvard_justice/anki_csv: English definitions (414) present in anki_csv — 0 missing e.g. []
...
- [x] collection:harvard_justice/eudic_quizlet: body is not empty — 112221 bytes
- [x] collection:harvard_justice/eudic_quizlet: body is valid UTF-8 text — 101070 chars
- [x] collection:harvard_justice/eudic_quizlet: body is not an error message — hurdling	/ˈhɜːrdlɪŋ/ v. (present participle) 疾驰、飞驰（形容失控电车高速冲下轨道）\nmoving rapidly and uncontrollably forward, as a vehicl
- [x] collection:harvard_justice/eudic_quizlet: every word present in the eudic_quizlet payload — 0 missing e.g. []
- [x] collection:harvard_justice/eudic_quizlet: English definitions (414) present in eudic_quizlet — 0 missing e.g. []
...
- [x] collection:harvard_justice/words_only: body is not empty — 4580 bytes
- [x] collection:harvard_justice/words_only: body is valid UTF-8 text — 4580 chars
- [x] collection:harvard_justice/words_only: body is not an error message — hurdling
desperate
helpless
side track
sparing
...
- [x] collection:yale_philosophy/docx: body is not empty — 17266 bytes
- [x] collection:yale_philosophy/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] collection:yale_philosophy/docx: Content-Length matches the body — 17266 vs 17266
...
- [x] collection:custom_imports/docx: body is not empty — 10268 bytes
- [x] collection:custom_imports/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] collection:custom_imports/docx: Content-Length matches the body — 10268 vs 10268
...
- [x] vocab-bank/docx: body is not empty — 163230 bytes
- [x] vocab-bank/docx: body is really a zip package — magic=b'PK\x03\x04\x14\x00\x00\x00'
- [x] vocab-bank/docx: Content-Length matches the body — 163230 vs 163230
...
- [x] vocab-bank/study_guide_md: body is not empty — 209061 bytes
- [x] vocab-bank/study_guide_md: body is valid UTF-8 text — 153829 chars
...
- [x] vocab-bank/study_guide_md: English definitions (502) present in study_guide_md — 0 missing e.g. []
...
- [x] vocab-bank/anki_csv: body is not empty — 950443 bytes
- [x] vocab-bank/anki_csv: body is valid UTF-8 text — 834651 chars
...
- [x] vocab-bank/anki_csv: English definitions (502) present in anki_csv — 0 missing e.g. []
...
- [x] vocab-bank/eudic_quizlet: body is not empty — 197330 bytes
- [x] vocab-bank/eudic_quizlet: body is valid UTF-8 text — 142196 chars
- [x] vocab-bank/eudic_quizlet: body is not an error message — utilitarianism	/ˌjuːtɪlɪˈteriənɪzəm/ n. 功利主义，功利论（以多数人利益和幸福为衡量正义的标准）\nthe belief that the right action is the one that pr
- [x] vocab-bank/eudic_quizlet: every word present in the eudic_quizlet payload — 0 missing e.g. []
- [x] vocab-bank/eudic_quizlet: English definitions (502) present in eudic_quizlet — 0 missing e.g. []
...
- [x] vocab-bank/words_only: body is not empty — 5775 bytes
- [x] vocab-bank/words_only: body is valid UTF-8 text — 5775 chars
