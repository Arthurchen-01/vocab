# Gate report - s7b_export_docx

- finished: 2026-09-17 21:28:25
...
- [x] every text run sets ascii/hAnsi/eastAsia/cs — 0 of 1374 runs incomplete
...
- [x] document carries extractable text — 40456 chars
- [x] every word appears in the document — 0 missing e.g. []
- [x] every def_cn appears in the document — 0 missing e.g. []
- [x] every def_en appears in the document — 0/163 missing e.g. []
- [x] table has one row per word plus a header — 164 rows for 163 words
- [x] declared word count matches the payload — meta line: 共收录 163 个学术词汇 · 英文释义 163 条 · 导出于 2026-09-17 12:26
